...
export function Room(){
    ...
    async function handleCreateNewQuestion(event: FormEvent) {
        ...
        const question = { //obj com as infos das perguntas
            content: newQuestion,
            author: {
                name: user.name,
                avatar: user.avatar,
            },
            isHighlighted: false, //se essa pergunta esta com destaque
            isAnswered: false, //se a pergunta foi respondia
        };

        await database.ref(`/rooms/${roomId}/questions`).push(question)

        setNewQuestion(''); //tira o valor do textarea depois de enviar a pergunta
    }
